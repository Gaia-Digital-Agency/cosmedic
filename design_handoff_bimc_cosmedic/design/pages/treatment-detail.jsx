...
window.TREATMENT_CONTENT = {
  ...
  recovery: {
    chapter: "Chapter II.05 — Recovery & Wellness",
    title: ["Recover", "in paradise."],
    lede: "Private villas, daily nursing visits, and gentle wellness — the small kindnesses that turn medical recovery into something closer to a retreat.",
    leadSurgeon: "suka",
    overview:
      "Recovery is half of the work. We have spent twenty-eight years in Bali learning what makes recovery here so different from recovery elsewhere — and we have built a programme that turns the worst part of any procedure into a quiet, careful retreat.",
    sections: [
      { id: "villas", t: "The villas", body: "We work with a small, hand-selected portfolio of villas in Nusa Dua, Jimbaran, and Ubud. Every villa has a private pool, twenty-four-hour security, and a kitchen that we provision before your arrival. Most are within fifteen minutes of the BIMC hospital." },
      { id: "nursing", t: "Daily nursing", body: "A registered nurse visits your villa every morning for the first seven days post-procedure: dressings, observations, and a small physiotherapy session where appropriate. From day eight, visits are every second day. Nurses speak English, Bahasa, and Mandarin." },
      { id: "wellness", t: "Wellness", body: "We pair recovery with the smallest possible amount of wellness — gentle physiotherapy, lymphatic drainage, post-operative nutrition, and no more than that. We are wary of doing too much during a healing window." },
      { id: "follow-up", t: "Twelve-month follow-up", body: "Once you fly home, our follow-up programme continues for twelve months: video reviews at the one-week, one-month, three-month, six-month, and twelve-month marks. Beyond that, we are always reachable." },
    ],
    procedures: [
      { n: "Recovery villa stays", d: "Five to twenty-one days. Hand-selected villas, fully provisioned.", priceFrom: "AUD 280 / night" },
      { n: "Daily in-villa nursing", d: "Registered nurse, twenty-four-hour on-call. Includes all dressings.", priceFrom: "AUD 180 / visit" },
      { n: "Manual lymphatic drainage", d: "Specialist post-operative therapist. Three to six sessions.", priceFrom: "AUD 140 / session" },
      { n: "Post-op nutrition", d: "Bespoke meal plan, prepared in-villa. Daily delivery.", priceFrom: "AUD 80 / day" },
      { n: "Gentle physiotherapy", d: "From day three. Tailored to procedure and progress.", priceFrom: "AUD 160 / session" },
      { n: "Aftercare follow-up", d: "Twelve months of video reviews. Included with surgical packages.", priceFrom: "Included" },
    ],
    faqs: [
      { q: "Do I need to stay in a villa, or can I go to a resort?", a: "Resorts work for some patients, particularly for non-surgical work. For surgical recovery, we strongly recommend our villa programme — privacy, quiet, and proximity to nursing matter more than amenities." },
      { q: "Can my family stay with me?", a: "Yes, and we encourage it. Most of our villas have two to four bedrooms and can accommodate a partner, child, or carer at no additional cost beyond meal provisioning." },
      { q: "What about food during recovery?", a: "Our nutritionist prepares a post-operative meal plan, prepared in-villa daily. We avoid raw food, alcohol, and inflammatory ingredients during the first ten days; everything else is up to you." },
    ],
    pricing: [
      { tier: "Five-night villa", italic: "Non-surgical or short surgical", amount: "1,800", from: "AUD · from", small: "Villa + nursing", items: ["Five nights in private villa", "Three nursing visits", "Welcome provisioning", "Driver on call", "Twelve-month follow-up"], cta: "Add to plan" },
      { tier: "Ten-night programme", italic: "Most surgical patients", amount: "3,400", from: "AUD · from", small: "Villa + nursing + wellness", items: ["Ten nights in private villa", "Seven nursing visits", "Three lymphatic drainage", "Post-op nutrition plan", "Family accommodation"], cta: "Plan your stay", featured: true },
      { tier: "Two-week retreat", italic: "Larger surgery, slower recovery", amount: "4,800", from: "AUD · from", small: "14-night programme", items: ["Fourteen nights in villa", "Daily nursing", "Six lymphatic drainage", "Daily nutrition plan", "Three physiotherapy sessions", "Concierge throughout"], cta: "Plan your retreat" },
    ],
  },
  concierge: {
    chapter: "Chapter II.06 — Concierge",
    title: ["From first call,", "to homecoming."],
    lede: "End-to-end coordination of treatment, travel, and everything in between — a single point of contact who knows your case from beginning to end.",
    leadSurgeon: "suka",
    overview:
      "Our concierge is not a customer-service team. They are a small group of trained coordinators, most with a background in nursing or hospitality, who take on a case from first enquiry and stay with it through the year of follow-ups that follows. You will know your concierge by name within a day of writing to us.",
    sections: [
      { id: "before", t: "Before you arrive", body: "From the moment you write to us, your concierge handles the coordination — consultation scheduling, treatment planning, visa support where needed, and the dozens of small questions that come before any medical visit. They will hold your case alongside our surgical team, from a single point of view." },
      { id: "arrival", t: "On arrival", body: "We meet every patient personally at Ngurah Rai International Airport. Our drivers know which villa or hotel you are staying at; your concierge will be at the welcome by the door of the car. We will not let you sort out a SIM card or a coffee before we have you settled." },
      { id: "during", t: "During your stay", body: "Your concierge is reachable on WhatsApp, twenty-four hours, for anything: an extra cushion, a missing prescription, a rescheduled scan, or a quiet question about how recovery is going. They speak the language of your home country." },
      { id: "after", t: "After you fly home", body: "The concierge relationship continues for twelve months — coordinating video follow-ups, arranging onward care if needed, and quietly checking in at the one-week, one-month, and three-month marks. Many patients keep their concierge's WhatsApp on speed dial for years." },
    ],
    procedures: [
      { n: "Airport transfers", d: "Black-car service to villa or hotel. Met by concierge at gate.", priceFrom: "Included" },
      { n: "Visa coordination", d: "Letters of support and visa-on-arrival assistance.", priceFrom: "Included" },
      { n: "Translation services", d: "Bahasa, Mandarin, Japanese, Korean, French, and Russian.", priceFrom: "Included" },
      { n: "Family accommodation", d: "Coordination of partner or carer accommodation.", priceFrom: "From AUD 180 / night" },
      { n: "Twelve-month telehealth", d: "Five scheduled follow-up calls; unlimited messaging.", priceFrom: "Included" },
    ],
    faqs: [
      { q: "Is concierge an extra service?", a: "No. Concierge is included with every surgical package and most non-surgical packages. There is nothing to sign up for; you will hear from your concierge within twenty-four hours of your enquiry." },
      { q: "Can I keep the same concierge for follow-ups?", a: "Yes, always. Your concierge stays with your case for a minimum of twelve months, and many of our long-term patients have worked with the same concierge for five or more years." },
      { q: "Do you help with onward care if I need it back home?", a: "Yes. We maintain a small network of trusted plastic surgeons and dermatologists in Sydney, Singapore, Tokyo, and Los Angeles, and we will coordinate referrals where appropriate at no additional charge." },
    ],
    pricing: [
      { tier: "Concierge included", italic: "With every package", amount: "0", from: "Included", small: "End-to-end coordination", items: ["Single point of contact", "Visa & travel coordination", "Airport welcome", "WhatsApp 24/7", "Twelve-month follow-up"], cta: "Begin enquiry" },
      { tier: "Family programme", italic: "Travel with partner or carer", amount: "180", from: "AUD · from / night", small: "Add to any package", items: ["Family accommodation", "Drivers for non-patients", "Family meal provisioning", "Activities coordination", "Same concierge"], cta: "Add to plan", featured: true },
      { tier: "Bespoke", italic: "Highly customised journeys", amount: "—", from: "On request", small: "By private referral", items: ["Private clinic access", "Senior surgeon time", "Dedicated villa & staff", "Helicopter transfers", "Multi-week stays"], cta: "Speak privately" },
    ],
  },
};
    ...
    <PageShell activePage={`treatment-${slug}`}>
      ...
      <div className="detail-layout">
        ...
        <div className="detail-body">
          <section id="overview">
            <Reveal>
              <Mono>I — Overview</Mono>
              <p className="lede" style={{ marginTop: 16 }}>{c.overview}</p>
            </Reveal>
            ...
            <div style={{ marginTop: 32, borderTop: "1px solid var(--ink-20)" }}>
              {c.procedures.map((p, i) => {
                ...
                const rowContent = (
                  ...
                  onMouseEnter={e => { if (procSlug) e.currentTarget.style.paddingLeft = "8px"; }}
                  onMouseLeave={e => { e.currentTarget.style.paddingLeft = "0"; }}
                  >
                    <h4 style={{ fontFamily: "var(--font-serif)", fontSize: 22, fontWeight: 400, margin: 0, letterSpacing: "-0.005em", display: "flex", alignItems: "baseline", gap: 12 }}>
                      <span>{p.n}</span>
                      {procSlug && <span style={{ fontFamily: "var(--font-mono)", fontSize: 9, letterSpacing: "0.18em", color: "var(--accent-deep)", textTransform: "uppercase" }}>read →</span>}
                    </h4>
          ...
          <section id="pricing">
            ...
            <Reveal delay={100}><p>Indicative packages, in Australian dollars. Every plan is priced individually after consultation.</p></Reveal>
            <div className="pricing-grid" style={{ marginTop: 40 }}>
              {c.pricing.map((p, i) => {
                // Compute IDR + AUD pair from `amount` (e.g. "8,500", "—", "0")
                  ...
                  <Reveal key={i} delay={i * 80}>
                    <div className={`pricing-card ${p.featured ? "featured" : ""}`}>
                      ...
                      <div className="price-amount">
                        ...
                        <small>{p.from}{p.small ? " · " + p.small : ""}</small>
                      </div>
