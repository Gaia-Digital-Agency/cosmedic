  ...
  fields: [
    apiWarningField,
    {
      ...
      fields: [
        ...
        { name: 'subCategoriesLabel', type: 'text', defaultValue: 'Sub-categories',
          admin: { description: 'Label for the Sub-categories anchor (shown only when the discipline has sub-categories).' } },
        { name: 'proceduresLabel', type: 'text', defaultValue: 'Procedures',
    ...
    },
    {
      ...
      fields: [
        { name: 'heading', type: 'text', defaultValue: 'Choose a focus',
          admin: { description: 'h2 heading above the sub-category list.' } },
        { name: 'bodyTemplate', type: 'textarea',
          defaultValue:
        ...
        { name: 'availableLabel', type: 'text', defaultValue: 'Read more →',
          admin: { description: 'CTA shown on a sub-category card when its detail page is live.' } },
        { name: 'comingLabel', type: 'text', defaultValue: 'Coming v1.4',
    ...
    },
    {
      ...
      fields: [
        { name: 'heading', type: 'text', defaultValue: 'Procedures',
    ...
    },
    {
      ...
      fields: [
        ...
        { name: 'headingRoman', type: 'text', defaultValue: 'alongside.',
