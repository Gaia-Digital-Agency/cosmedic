...
export const TreatmentsIndexSection: GlobalConfig = {
  ...
  fields: [
    { name: 'eyebrow', label: 'Label above heading', type: 'text', localized: true, defaultValue: 'An Index',
      admin: { description: 'Small-caps eyebrow above the section title.' } },
    { name: 'heading', type: 'text', localized: true, defaultValue: 'Browse by discipline.',
