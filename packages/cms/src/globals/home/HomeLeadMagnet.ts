  ...
  fields: [
      ...
      admin: { description: 'Eyebrow on the right-side body column.', hidden: true } },
    {
      ...
      fields: [
        ...
        { name: 'b', type: 'text', localized: true, defaultValue: 'recovery in Bali.',
    ...
    { name: 'formPlaceholder', type: 'text', localized: true, defaultValue: 'Your email address',
      admin: { description: 'Email input placeholder.' } },
    { name: 'submitLabel', type: 'text', localized: true, defaultValue: 'Send Guide →',
      admin: { description: 'Submit-button label.' } },
    { name: 'successHeading', type: 'text', localized: true, defaultValue: '✓ Sent',
      admin: { description: 'Heading shown in the success state.', hidden: true } },
    { name: 'successBody', type: 'text', localized: true, defaultValue: 'Check your inbox — the guide is on its way.',
      admin: { description: 'Body shown in the success state.', hidden: true } },
    { name: 'fineprint', type: 'text', localized: true, defaultValue: 'One email. No marketing list. Unsubscribe anytime.',
