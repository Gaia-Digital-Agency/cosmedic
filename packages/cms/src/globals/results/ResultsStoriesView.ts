...
export const ResultsStoriesView: GlobalConfig = {
  ...
  fields: [
    { name: 'eyebrow', label: 'Label above heading', type: 'text', localized: true, defaultValue: 'Stories',
      admin: { description: 'Section eyebrow above the heading.' } },
    { name: 'headingPre', type: 'text', localized: true, defaultValue: 'Stories,',
      admin: { description: 'First line of the heading (roman).' } },
    { name: 'headingItalic', type: 'text', localized: true, defaultValue: 'not slogans.',
