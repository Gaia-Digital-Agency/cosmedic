...
export const LibraryCta: GlobalConfig = {
  ...
  fields: [
    // ── Library CTA ───────────────────────────────────────────────────────────
    { name: 'eyebrow', label: 'Library — label above heading', type: 'text', localized: true, defaultValue: 'Private gallery',
      admin: { description: 'Small-caps eyebrow above the Library CTA heading.' } },
    { name: 'headingPre', label: 'Library — heading (roman)', type: 'text', localized: true, defaultValue: 'Want to see ',
      admin: { description: 'First part of Library CTA heading (roman).' } },
    { name: 'headingItalic', label: 'Library — heading (italic)', type: 'text', localized: true, defaultValue: 'more?',
      admin: { description: 'Italic word(s) inside Library CTA heading.' } },
    { name: 'body', label: 'Library — body', type: 'textarea', localized: true,
    ...
    { name: 'buttonLabel', label: 'Library — button label', type: 'text', localized: true, defaultValue: 'Request the full library',
    ...
    // ── Share CTA ─────────────────────────────────────────────────────────────
    {
      ...
      fields: [
        { name: 'eyebrow', label: 'Label above heading', type: 'text', localized: true, defaultValue: 'Sharing your story',
          admin: { description: 'Small-caps eyebrow.' } },
        { name: 'headingPre', label: 'Heading (roman)', type: 'text', localized: true, defaultValue: 'Have a ',
          admin: { description: 'Roman part before italic.' } },
        { name: 'headingItalic', label: 'Heading (italic)', type: 'text', localized: true, defaultValue: 'story',
          admin: { description: 'Italic word inside heading.' } },
        { name: 'headingPost', label: 'Heading (roman tail)', type: 'text', localized: true, defaultValue: ' to share?',
        ...
        { name: 'buttonLabel', label: 'Button label', type: 'text', localized: true, defaultValue: 'Write to us',
