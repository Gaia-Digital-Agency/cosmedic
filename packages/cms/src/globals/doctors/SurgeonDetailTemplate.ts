...
export const SurgeonDetailTemplate: GlobalConfig = {
  ...
  fields: [
    ...
    // ─── Hero ────────────────────────────────────────────────────────────
    { name: 'heroLeadLabel', type: 'text', required: true, localized: true, defaultValue: 'Lead Surgeon',
      admin: { description: 'Eyebrow shown on the detail page when the surgeon\'s "lead" flag is TRUE.' } },
    { name: 'heroSpecialistLabel', type: 'text', required: true, localized: true, defaultValue: 'Specialist',
      admin: { description: 'Eyebrow shown when the surgeon\'s "lead" flag is FALSE.' } },
    { name: 'heroCtaConsultLabel', type: 'text', required: true, localized: true, defaultValue: 'Request a consultation',
    ...
    { name: 'heroCtaTreatmentsLabelFallback', type: 'text', required: true, localized: true, defaultValue: 'Treatments',
    ...
    // ─── Stats row ───────────────────────────────────────────────────────
    { name: 'statLabelYears', type: 'text', required: true, localized: true, defaultValue: 'Years in practice',
    ...
    // ─── Biography sidebar ───────────────────────────────────────────────
    { name: 'sidebarLabelSpecialism', type: 'text', required: true, localized: true, defaultValue: 'Specialism',
      admin: { description: 'Sidebar definition-list label for the doctor\'s specialism / group.' } },
    { name: 'sidebarLabelCredentials', type: 'text', required: true, localized: true, defaultValue: 'Credentials',
      admin: { description: 'Sidebar definition-list label for the credentials line.' } },
    { name: 'sidebarLabelLanguages', type: 'text', required: true, localized: true, defaultValue: 'Languages',
      admin: { description: 'Sidebar definition-list label for the languages list.' } },
    { name: 'sidebarLabelAvailability', type: 'text', required: true, localized: true, defaultValue: 'Availability',
      admin: { description: 'Sidebar definition-list label for the availability schedule.' } },
    { name: 'languagesFallback', type: 'text', required: true, localized: true, defaultValue: 'English · Bahasa Indonesia',
      admin: { description: 'Fallback rendered when the surgeon record has no `languages` rows.' } },
    { name: 'availabilityFallback', type: 'text', required: true, localized: true, defaultValue: 'Mon & Thu in person · weekday mornings by video',
      admin: { description: 'Fallback rendered when the surgeon record has no `availabilitySchedule` rows.' } },

    // ─── Faculty section ─────────────────────────────────────────────────
    { name: 'facultyEyebrow', type: 'text', required: true, localized: true, defaultValue: 'The faculty',
      admin: { description: 'Eyebrow above the "Meet the other practitioners" card grid.' } },
    {
      ...
      fields: [
        { name: 'pre', type: 'text', required: true, localized: true, defaultValue: 'Meet the ',
          admin: { description: 'Roman prefix before the italic. Default "Meet the ". Include trailing space.' } },
        { name: 'italic', type: 'text', required: true, localized: true, defaultValue: 'other practitioners.',
          admin: { description: 'The italic phrase. Default "other practitioners.".' } },
        { name: 'post', type: 'text', localized: true, defaultValue: '',
          admin: { description: 'Roman suffix after the italic, if any. Default empty.' } },
      ],
    },

    // ─── Specialty areas ─────────────────────────────────────────────────
    { name: 'specialtyEyebrow', type: 'text', required: true, localized: true, defaultValue: 'Specialty areas',
      admin: { description: 'Eyebrow above the specialty-area grid.' } },
    { name: 'specialtyHeadingTemplate', type: 'textarea', required: true, localized: true,
      admin: {
        description:
    ...
    { name: 'trainingEyebrow', type: 'text', required: true, localized: true, defaultValue: 'Training & credentials',
    ...
    { name: 'biographyEyebrow', type: 'text', required: true, localized: true, defaultValue: 'Biography',
      admin: { description: 'Eyebrow above the biography sidebar.' } },
    { name: 'secondaryBioParagraph', type: 'textarea', required: true, localized: true,
      admin: {
        description:
