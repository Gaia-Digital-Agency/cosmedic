  ...
  <PageShell activePage="results">
    ...
    <section className="page-section" id="results">
      ...
      <Reveal>
        ...
        >
          ...
          >
            Our complete library — over two hundred consented cases across every discipline — is
            shared during private consultation. We will match what we show you to the work you are
            considering.
          </p>
    ...
    <section className="page-section tinted" id="stories">
      <div className="section-anchor-head">
        ...
        <p className="section-lede" style={{ maxWidth: 640 }}>
          Eight stories from the last two years of patients, shared with their permission.
          Editorial restraint over marketing copy — these are the patients we're proudest to have
          served.
        </p>
      </div>
          ...
          <Reveal key={i} delay={0} y={24}>
            <article className="story-row">
              <div className="story-row-img">
                <Img
                  src={STORY_PORTRAITS[i % STORY_PORTRAITS.length]}
      ...
      <Reveal>
        <div style={{ textAlign: 'center', maxWidth: 720, margin: '80px auto 0' }}>
          ...
          >
            Have a <span className="italic">story</span> to share?
          </h3>
          <p
            style={{
              margin: '0 auto 28px',
          ...
          >
            We never solicit testimonials — every story we publish is shared at the patient's
            instigation, in their own words, with their consent. If you'd like to share, we would
            be honoured to read it.
          </p>
          <Btn kind="primary" as="a" href="/contact">
            Write to us
          </Btn>
