...
export const BLOG_POST_BODIES: Record<string, BlogPostFull> = {
  ...
  // q13 placeholders — the 6 essays below exist as cards on /blog (from BLOG_POSTS)
  // but their full bodies are still in editorial. Shipping a stub body so the
  // detail routes return 200 instead of 404; replace with full prose when each
  // essay clears edit.
  'before-you-fly': {
    slug: 'before-you-fly',
    title: 'Before you fly: a six-week pre-op letter.',
    ...
    authorSlug: 'suka',
    body: [
      { kind: 'p', text: 'This essay is being finalised. In the meantime, our concierge team can walk you through the pre-operative timeline directly — please write to us or book a 20-minute video consult, and we will send the relevant chapter ahead of time.' },
    ],
    related: ['the-villa-protocol', 'the-quiet-rhinoplasty'],
  },
  'the-villa-protocol': {
    slug: 'the-villa-protocol',
    title: 'The villa protocol.',
    ...
    authorSlug: 'suka',
    body: [
      { kind: 'p', text: 'This essay is being finalised. In the meantime, our concierge team can walk you through the villa recovery protocol directly — please write to us or book a 20-minute video consult, and we will share the full document ahead of time.' },
    ],
    related: ['before-you-fly', 'the-quiet-rhinoplasty'],
  },
  'fillers-restraint': {
    slug: 'fillers-restraint',
    title: 'On fillers, restraint, and the long view.',
    ...
    authorSlug: 'rosa',
    body: [
      { kind: 'p', text: 'This essay is being finalised. In the meantime, you are welcome to book a 20-minute video consult with our aesthetic-medicine team for a personalised discussion.' },
    ],
    related: ['the-quiet-rhinoplasty', 'dental-veneers-honesty'],
  },
  'achsi-what-it-means': {
    slug: 'achsi-what-it-means',
    title: 'What ACHSI accreditation actually means.',
    ...
    authorSlug: 'suka',
    body: [
      { kind: 'p', text: 'This essay is being finalised. In the meantime, please refer to our /press page for accreditation details, or write to us for a copy of the most recent ACHSI audit summary.' },
    ],
    related: ['the-quiet-rhinoplasty', 'crani-bali'],
  },
  'crani-bali': {
    slug: 'crani-bali',
    title: 'Craniomaxillofacial surgery in Bali, in 2026.',
    ...
    authorSlug: 'wara',
    body: [
      { kind: 'p', text: 'This essay is being finalised. In the meantime, you are welcome to book a 20-minute video consult to speak with our craniomaxillofacial team about specific cases or referrals.' },
    ],
    related: ['the-quiet-rhinoplasty', 'achsi-what-it-means'],
  },
  'dental-veneers-honesty': {
    slug: 'dental-veneers-honesty',
    title: 'Veneers: what we say no to.',
    dek: 'Why we turn down roughly one in three veneer consultations — and the questions we ask first.',
    category: 'Dental',
    ...
    authorSlug: 'theresia',
    body: [
      { kind: 'p', text: 'This essay is being finalised. In the meantime, please book a 20-minute video consult with our dental-aesthetics team for a candid pre-treatment discussion.' },
    ],
    related: ['the-quiet-rhinoplasty', 'fillers-restraint'],
  },
}
