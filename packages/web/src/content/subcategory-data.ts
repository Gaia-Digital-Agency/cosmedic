/**
 * Sub-category data. Each entry maps a discipline → sub-category to a list of
 * inline treatments displayed as accordion rows on the sub-category page.
 * Ported verbatim from `design/pages/subcategory-data.jsx` (window.SUBCATEGORY_DATA).
 * Phase 6 migrates this to the SubCategories collection.
 *
 * Schema:
 *   parent       — slug of parent discipline (e.g. "surgical")
 *   slug         — full slug, used in URL: /treatment-{slug}
...
export const SUBCATEGORY_DATA: Record<string, SubCategoryEntry> = {
  "surgical-breast": {
    parent: "surgical",
...
SUBCATEGORY_DATA["surgical-face"] = {
...
SUBCATEGORY_DATA["surgical-body"] = {
...
SUBCATEGORY_DATA["non-surgical-injectables"] = {
...
SUBCATEGORY_DATA["non-surgical-laser"] = {
...
SUBCATEGORY_DATA["non-surgical-skin"] = {
...
SUBCATEGORY_DATA["dental-veneers"] = {
...
SUBCATEGORY_DATA["dental-alignment"] = {
...
SUBCATEGORY_DATA["dental-whitening"] = {
...
SUBCATEGORY_DATA["recovery-villas"] = {
...
SUBCATEGORY_DATA["recovery-therapies"] = {
...
SUBCATEGORY_DATA["concierge-travel"] = {
...
SUBCATEGORY_DATA["concierge-stay"] = {
...
SUBCATEGORY_DATA["concierge-aftercare"] = {
...
SUBCATEGORY_DATA["weight-loss-medical"] = {
...
SUBCATEGORY_DATA["weight-loss-endoscopic"] = {
...
SUBCATEGORY_DATA["weight-loss-surgical"] = {
...
SUBCATEGORY_DATA["reconstructive-breast"] = {
...
SUBCATEGORY_DATA["reconstructive-trauma"] = {
...
SUBCATEGORY_DATA["reconstructive-craniofacial"] = {
