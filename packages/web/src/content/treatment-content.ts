/**
 * Per-discipline editorial content for the DisciplineDetail template.
 * Ported verbatim from `design/pages/treatment-detail.jsx` (window.TREATMENT_CONTENT).
 * Phase 6 migrates this to the Disciplines collection.
 */
...
export const TREATMENT_CONTENT: Record<string, DisciplineContent> = {
  surgical: {
