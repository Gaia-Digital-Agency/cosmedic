...
| 25.5 | Phase 10 imagery gaps — **LAUNCH-BLOCKING** | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |
| 25.6 | Figma MCP inventory pipeline (BLOCKED — file not shared with MCP user) | [ ] | [ ] | [ ] | [ ] | [ ] | [ ] |
| 25.7 | N1/N2/N3 polish trio | [x] | [x] | [x] | [x] | [x] | [x] |
| 25.8 | Back-to-Top ↔ WhatsApp FAB vertical gap (define + apply) | [x] | [x] | [x] | [x] | [ ] | [ ] |
| 25.8a | Back-to-Top ↔ WhatsApp center-X alignment on mobile | [x] | [x] | [x] | [x] | [ ] | [ ] |
| 25.9 | Starburst texture clarify (comment fix; radial-gradient glow already shipped) | [x] | [x] | [x] | [x] | [ ] | [ ] |
...
| 25.5 | Close Phase 10 imagery gaps — 23 lifestyle/villa/hero slots + 25/29 Before/After composites. | Placeholder images visible to visitors. Launch-blocking. | `packages/web/public/assets/` · Payload Media collection · `phase-10-imagery-gaps.md` tracker. | AI-generate 23 slots against brand brief; clinical sign-off on 25 BA composites; `pnpm seed:media` re-run; extend `media={...}` to 19 remaining `<Img>` call sites. | ❌ Open. **Launch-blocking.** |
...
| 25.12 | Audit Phase C6–C10 — what's actually left after Phase R closures? | C6 = Home A2 (R2 scope), C7 = Pricing A2 (R6 scope), C8 = Before/After wiring, C9 = Pricing unification (high-risk), C10 = final audit. Most superseded by R. | `docs/planning/all_todo.md` Phase C section. | Per-C-item check vs. R-phase deliverables. Remove or merge obsolete rows in `all_todo.md`. | ❌ Open — doc-only cleanup, low effort. |
