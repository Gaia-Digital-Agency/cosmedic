...
| 12b | **C9c-delete** | Delete the 4 stale collections (PriceListItems/MachineTreatments/InjectableProducts/HairRemovalAreas) | — | deferred | Pending user sign-off on the C9c-renderer /pricing output |
