...
const { Reveal, Img, Mono, Eyebrow, Btn, PageShell, ChapterOpener, TrustBar, IMG, TREATMENT_LIST } = window;
...
const Page = () => {
  ...
  const intentCopy = {
    estimate: { eyebrow: "Written estimate", title: "Get a written estimate.", lede: "Tell us a little, and a coordinator will reply within 24 hours with a tailored, itemised estimate — no marketing, no follow-on calls." },
    "video-consult": { eyebrow: "Video consult", title: "Book a video consult.", lede: "A free 20-minute video call with a coordinator. No surgeon time required at this stage — we'll triage and brief the right surgeon afterwards." },
  };
  const intent = intentCopy[prefillIntent];
  ...
  <PageShell activePage="contact" hideCTA>
    <ChapterOpener
      ...
      lede={intent ? intent.lede : "Write to us in your own time, in your own words. A concierge will reply within twenty-four hours, in English or Bahasa Indonesia. There is no obligation — and no pressure — to proceed."}
      image={IMG.reception}
      imageHue={3}
        ...
        <Reveal delay={120}>
          <form className="contact-form-grid" onSubmit={e => e.preventDefault()}>
            <label className="field field-full">
              <span className="field-label">Your name <em style={{fontFamily:"var(--font-serif)", fontStyle:"italic", color:"#B45A3C", fontSize:12, marginLeft:6}}>required</em></span>
              <input type="text" placeholder="First name" required />
            </label>
            <label className="field field-full">
              <span className="field-label">Email <em style={{fontFamily:"var(--font-serif)", fontStyle:"italic", color:"#B45A3C", fontSize:12, marginLeft:6}}>required</em></span>
              <input type="email" placeholder="you@example.com" required />
            </label>
            <label className="field field-full">
              <span className="field-label">Area of interest <em style={{fontFamily:"var(--font-serif)", fontStyle:"italic", color:"#B45A3C", fontSize:12, marginLeft:6}}>required</em></span>
            ...
            <div className="field-full" style={{ borderTop: "1px solid var(--ink-20)", paddingTop: 24, marginTop: 8 }}>
              {!showOptional && (
            ...
            {showOptional && (
              <>
                <label className="field">
                  <span className="field-label">Country & city <em style={{fontStyle:"italic", color:"var(--ink-40)", fontSize:12, marginLeft:6}}>optional</em></span>
                  <input type="text" placeholder="Sydney, Australia" />
                </label>
                <label className="field">
                  <span className="field-label">Approximate dates <em style={{fontStyle:"italic", color:"var(--ink-40)", fontSize:12, marginLeft:6}}>optional</em></span>
                  <input type="text" placeholder="Month / year" />
                </label>
                <label className="field field-full">
                  <span className="field-label">Tell us a little <em style={{fontStyle:"italic", color:"var(--ink-40)", fontSize:12, marginLeft:6}}>optional</em></span>
